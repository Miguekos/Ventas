...
if ($fact == $factP) {
    ...
    for($x = 1; $x <= count($_POST['totalitem']); $x++) {
            ...
            $guardar = "insert into ventas (id_factura, id_producto, nombre, categoria, cantidad, id_monto, total, estado) values ('$factP','$id','$nombre','$categoria','$nu2','$nu1','$nu3','1')";
            //echo $guardar;
			...
			while($rowC = mysqli_fetch_array($result1)){
				...
				//echo $restarCantidad;
                $inserVenta = "insert into inventario (id_producto, venta, compra) values ('$id','$nu2','0')";
...
echo "<p id='pago'></p>";
echo "<a onkeydown='enter4()' id='nuevaventa' class='btn btn-success text-center centro' href='index.php'> Nueva Venta</a>";
echo "</form>";
?>
</body>
<script>
